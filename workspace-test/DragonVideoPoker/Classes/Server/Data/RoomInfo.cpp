...
void RoomInfoJackpot::updateValue(const long long &pValue) {
...
{    
    ...
    mJackpot                = 0;
    mRoomInfoJackpot        = new RoomInfoJackpot();
}
...
void RoomInfo::setJackpot(long long var) {
    mJackpot = var;
    mRoomInfoJackpot->updateValue(var);
}