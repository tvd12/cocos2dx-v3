...
public:
    ...
    //update first name
    void sendUpdateFirstNameRequest(const string &pFirstName);
    
    //update leaderboard
    void sendUpdateLeaderboardRequest();
    ...
    //leaderboard
    CC_SYNTHESIZE(Leaderboard*, mLeaderboard, Leaderboard);
...
#define LEADERBOARD()   TdgServer::getSingleton().getLeaderboard()
