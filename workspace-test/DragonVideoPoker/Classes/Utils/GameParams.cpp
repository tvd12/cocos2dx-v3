...
void GameParams::getUserDefaultSettings()
{
    ...
    isDoubleSpeedGameEnabled = CCUserDefault::sharedUserDefault()->getBoolForKey(USER_DEFAULT_DOUBLE_SPEED_GAME, false);
}
...
void GameParams::initIphone4_5Params()
{
    ...
    LBB_HEADER_LEADERBOARD_BUTTON_POSITION              = MakePoint(297, 22);
    ...
    POP_SETTING_DOUBLE_SPEED_PLAY_LABEL_POSITION        = MakePointCommon(30, 118 + 4*44); //left
    ...
    POP_SETTING_DOUBLE_SPEED_PLAY_MENUITEM_POSITION     = MakePointCommon(233, 118 + 4*44);
...
//    POP_SETTING_INVITE_FRIEND_MENUITEM_POSITION         = MakePointCommon(214, 357);;
    POP_SETTING_RATE_US_MENUITEM_POSITION               = MakePointCommon(82, 357);
    POP_SETTING_FEEDBACK_MENUITEM_POSITION              = MakePointCommon(214, 357);
    ...
    POP_PROFILE_RENAME_MENUITEM_POSITION                = MakePointCommon(69, 71);
    ...
    POP_PROFILE_NAME_EDITBOX_WIDTH                      = 120;
    POP_PROFILE_NAME_EDITBOX_HEIGHT                     = CMM_FONT_SIZE_3*2;
     ...
     * by apple
     */
	POP_AVATARS_AVATARS_SPRITE_POSITIONS[0] 		= CCPoint(40 + 0*88, 52);
	POP_AVATARS_AVATARS_SPRITE_POSITIONS[1] 		= CCPoint(40 + 1*88, 52);
	POP_AVATARS_AVATARS_SPRITE_POSITIONS[2] 		= CCPoint(40 + 2*88, 52);
	POP_AVATARS_AVATARS_SPRITE_POSITIONS[3] 		= CCPoint(40 + 0*88, 52);
	POP_AVATARS_AVATARS_SPRITE_POSITIONS[4] 		= CCPoint(40 + 1*88, 52);
	POP_AVATARS_AVATARS_SPRITE_POSITIONS[5] 		= CCPoint(40 + 2*88, 52);
	POP_AVATARS_AVATARS_SPRITE_POSITIONS[6] 		= CCPoint(40 + 0*88, 52);
	POP_AVATARS_AVATARS_SPRITE_POSITIONS[7] 		= CCPoint(40 + 1*88, 52);
	POP_AVATARS_AVATARS_SPRITE_POSITIONS[8] 		= CCPoint(40 + 2*88, 52);
	...
	*/
	...
	POP_LEADERBOARD_BG_NUMBER_SPRITE_POSITION           = MakePointCommon(231.0, 452.5);
	POP_LEADERBOARD_BG_SPRITE_POSITION                  = MakePointCommon(132, 453.0);
	POP_LEADERBOARD_FRAME_AVATAR_SPRITE_POSITION 		= MakePointCommon(29.0, 453.0);
	POP_LEADERBOARD_LEADERBOARD_BANNER_SPRITE_POSITION 		= POP_COMMON_HEADER_POSITION;
	POP_LEADERBOARD_NUMBER_1_SPRITE_POSITION            = MakePointCommon(231.0, 452.5);
	POP_LEADERBOARD_NUMBER_2_SPRITE_POSITION            = MakePointCommon(231.0, 451.5);
	POP_LEADERBOARD_NUMBER_3_SPRITE_POSITION            = MakePointCommon(35.0, 114.5);
	POP_LEADERBOARD_USERCHIP_LABEL_POSITION             = MakePointCommon(55, 464);
	POP_LEADERBOARD_USERNAME_LABEL_POSITION             = MakePointCommon(55, 444);
	POP_LEADERBOARD_YOUR_PLACE_LABEL_POSITION           = MakePointCommon(20, 106);
    POP_LEADERBOARD_TABLE_POSITION                      = MakePointCommon(16, 423);
    POP_LEADERBOARD_TABLE_CELL_POSITION                 = CCPoint(132, 27);
    
    POP_LEADERBOARD_TABLE_SIZE                          = CCSizeMake(265, 300);
    POP_LEADERBOARD_TABLE_CELL_SIZE                     = CCSizeMake(261, 54);
    POP_LEADERBOARD_AVATAR_SIZE                         = CCSizeMake(40, 40);

	// CrazyUpgradePopupView positions initializing(demohd)
	// by apple Sat Aug 16 00:15:35 GMT+07:00 2014
	POP_CRAZY_UPGRADE_HELLO_MY_LOVE_LABEL_POSITION 		= CCPoint(137.0, -67.0);
	POP_CRAZY_UPGRADE_DUNG_TA_VAN_LABEL_POSITION 		= CCPoint(161.0, 27.0);

	POP_CRAZY_UPGRADE_HAHA_HAHA_SPRITE_POSITION 		= CCPoint(190.5, 69.0);
	POP_CRAZY_UPGRADE_CZ_REWARD_ICON_SPRITE_POSITION 		= CCPoint(27.5, 94.0);
	POP_CRAZY_UPGRADE_CZ_VIP_LEVEL_RIBBON_SPRITE_POSITION 		= CCPoint(160.0, 136.0);

	// CrazyShoppingPopupView positions initializing(demohd)
	// by apple Fri Sep 19 18:03:06 GMT+07:00 2014

	POPUP_CRAZY_SHOPPING_CZS_HEADER_SPRITE_POSITION			= CCPoint(148.5, 414.5);

	POPUP_CRAZY_SHOPPING_SHOPPING_TABLE_POSITION			= CCPoint(16.0, 65.0);
	POPUP_CRAZY_SHOPPING_SHOPPING_TABLE_SIZE			= CCSizeMake(264.0, 319.0);
	POPUP_CRAZY_SHOPPING_SHOPPING_CELL_POSITION			= CCPoint(132.0, 255.0);
	POPUP_CRAZY_SHOPPING_SHOPPING_CELL_SIZE			= CCSizeMake(264.0, 128.0);

	POPUP_CRAZY_SHOPPING_POP_COMMON_CLOSE_NORMAL_SPRITE_POSITION			= CCPoint(148.0, 30.0);

	POPUP_CRAZY_SHOPPING_PACKAGE_MENUITEM_POSITIONS[0]			= CCPoint(64.0, 68.0);
	POPUP_CRAZY_SHOPPING_TITLE_LABEL_POSITION			= CCPoint(65.0, 104.0);
	POPUP_CRAZY_SHOPPING_CHIPS_LABEL_POSITION			= CCPoint(52.0, 30.5);
	POPUP_CRAZY_SHOPPING_MONEY_LABEL_POSITION			= CCPoint(23.0, 12.0);

	POPUP_CRAZY_SHOPPING_CZS_CHIP_ICON_ACTIVE_SPRITE_POSITION			= CCPoint(19.5, 28.5);
	POPUP_CRAZY_SHOPPING_CZS_MAIN_ICON_ACTIVE_SPRITE_POSITION			= CCPoint(64.0, 65.0);
	POPUP_CRAZY_SHOPPING_CZS_CHIP_ICON_SPRITE_POSITION			= CCPoint(19.5, 28.5);
	POPUP_CRAZY_SHOPPING_CZS_MAIN_ICON_1_SPRITE_POSITION			= CCPoint(64.0, 65.0);

	POPUP_CRAZY_SHOPPING_CHILD_ACTIVE_MENUITEM_POSITION			= CCPoint(97.0, 22.5);
	POPUP_CRAZY_SHOPPING_CHILD_MENUITEM_POSITION			= CCPoint(97.0, 22.5);

	POPUP_CRAZY_SHOPPING_BUY_ACTIVE_MENU_POSITION			= CCPoint(0.0, 0.0);
	POPUP_CRAZY_SHOPPING_BUY_MENU_POSITION			= CCPoint(0.0, 0.0);
	POPUP_CRAZY_SHOPPING_PACKAGE_MENUITEM_POSITIONS[1]			= CCPoint(200.0, 68.0);

	POPUP_CRAZY_SHOPPING_SHOPPING_BG_MENU_POSITION			= CCPoint(0.0, 0.0);

	// CzaAvatarsPopupView positions initializing(demohd)
	// by apple Sat Sep 20 13:04:49 GMT+07:00 2014

	POPUP_CZA_AVATARS_CZA_COME_BACK_TEXT_SPRITE_POSITION			= CCPoint(150.0, 67.0);
	POPUP_CZA_AVATARS_CZA_HEADER_SPRITE_POSITION			= CCPoint(148.5, 414.5);
	POPUP_CZA_AVATARS_CZA_LV_PROGRESS_BG_SPRITE_POSITION			= CCPoint(104.0, 360.0);

	POPUP_CZA_AVATARS_CONTAINER_TABLE_POSITION			= CCPoint(17.0, 75.0);
	POPUP_CZA_AVATARS_CONTAINER_TABLE_SIZE			= CCSizeMake(264.0, 265.0);
	POPUP_CZA_AVATARS_CONTAINER_CELL_POSITION			= CCPoint(132.0, 209.5);
	POPUP_CZA_AVATARS_CONTAINER_CELL_SIZE			= CCSizeMake(264.0, 111.0);
	POPUP_CZA_AVATARS_CZA_FACEBOOK_ICON_SPRITE_POSITION			= CCPoint(47.5, 43.5);
	POPUP_CZA_AVATARS_CZA_INFRAME_SPRITE_POSITION			= CCPoint(38.5, 65.5);
	POPUP_CZA_AVATARS_CZA_SELECTED_SPRITE_POSITION			= CCPoint(36.0, 16.5);
	POPUP_CZA_AVATARS_CZA_USE_BACKGROUND_SPRITE_POSITION			= CCPoint(38.0, 51.5);
	POPUP_CZA_AVATARS_CZA_CURRENT_BACKGROUND_SPRITE_POSITIONS[0]			= CCPoint(43.0, 58.5);
	POPUP_CZA_AVATARS_CZA_CURRENT_BACKGROUND_SPRITE_POSITIONS[1]			= CCPoint(132.0, 58.5);
	POPUP_CZA_AVATARS_CZA_CURRENT_BACKGROUND_SPRITE_POSITIONS[2]			= CCPoint(221.0, 58.5);

	POPUP_CZA_AVATARS_USE_MENUITEM_POSITION			= CCPoint(38.5, 16.5);
	POPUP_CZA_AVATARS_DUNG_LABEL_POSITION			= CCPoint(28.0, 17.5);

	POPUP_CZA_AVATARS_USE_MENU_POSITION			= CCPoint(0.0, 0.0);
	POPUP_CZA_AVATARS_POP_COMMON_CLOSE_NORMAL_SPRITE_POSITION			= CCPoint(148.0, 30.0);
	//don't modify or delete this line(demohd)
...
void GameParams::initIpadParams()
{
     ...
     * by apple
     */
	POP_AVATARS_AVATARS_SPRITE_POSITIONS[0] 		= CCPoint(88 + 0*169, 95);
	POP_AVATARS_AVATARS_SPRITE_POSITIONS[1] 		= CCPoint(88 + 1*169, 95);
	POP_AVATARS_AVATARS_SPRITE_POSITIONS[2] 		= CCPoint(88 + 2*169, 95);
	POP_AVATARS_AVATARS_SPRITE_POSITIONS[3] 		= CCPoint(88 + 0*169, 95);
	POP_AVATARS_AVATARS_SPRITE_POSITIONS[4] 		= CCPoint(88 + 1*169, 95);
	POP_AVATARS_AVATARS_SPRITE_POSITIONS[5] 		= CCPoint(88 + 2*169, 95);
	POP_AVATARS_AVATARS_SPRITE_POSITIONS[6] 		= CCPoint(88 + 0*169, 95);
	POP_AVATARS_AVATARS_SPRITE_POSITIONS[7] 		= CCPoint(88 + 1*169, 95);
	POP_AVATARS_AVATARS_SPRITE_POSITIONS[8] 		= CCPoint(88 + 2*169, 95);
	POP_AVATARS_AVATAR_1_SPRITE_POSITION            = POP_AVATARS_INFRAME_SPRITE_POSITION;
	POP_AVATARS_AVATAR_2_SPRITE_POSITION            = POP_AVATARS_INFRAME_SPRITE_POSITION;
	POP_AVATARS_AVATAR_3_SPRITE_POSITION            = POP_AVATARS_INFRAME_SPRITE_POSITION;
	POP_AVATARS_AVATAR_4_SPRITE_POSITION            = POP_AVATARS_INFRAME_SPRITE_POSITION;
    ...
    POP_PROFILE_RENAME_MENUITEM_POSITION                = MakePoint(124, 264);
    ...
    POP_PROFILE_NICKNAME_LABEL_POSITION                 = MakePoint(66 + 0*242 + 23, 378 + 0*48);
    ...
    POP_PROFILE_WIN_RATIO_LABEL_POSITION                = MakePoint(57 + 450, 694 - 1*40);
    POP_PROFILE_BIGGEST_WIN_LABEL_POSITION              = MakePoint(57 + 450, 694 - 2*40);
    POP_PROFILE_HANDS_WON_LABEL_POSITION                = MakePoint(57 + 450, 694 - 3*40);
    POP_PROFILE_HANDS_PLAYED_LABEL_POSITION             = MakePoint(57 + 450, 694 - 4*40);
    ...
    POP_PROFILE_NAME_EDITBOX_WIDTH                      = 180;
    POP_PROFILE_NAME_EDITBOX_HEIGHT                      = 1.5*CMM_FONT_SIZE_3;
	...
	POP_VIP_UPGRADE_INAPP_LABEL_POSITION            = MakePoint(279, 881);
    ...
    POP_SETTING_DOUBLE_SPEED_PLAY_LABEL_POSITION        = MakePoint(54, 348 + 4*84); //left
    ...
    POP_SETTING_DOUBLE_SPEED_PLAY_MENUITEM_POSITION     = MakePoint(434, 348 + 4*84);
...
//    POP_SETTING_INVITE_FRIEND_MENUITEM_POSITION         = MakePoint(404, 800);;
    POP_SETTING_RATE_US_MENUITEM_POSITION               = MakePoint(151, 800);
    POP_SETTING_FEEDBACK_MENUITEM_POSITION              = MakePoint(404, 800);
    ...
    LBB_HEADER_LEADERBOARD_BUTTON_POSITION              = MakePoint(723, 46);
    ...
    NTF_BUTTON_CENTER_POSITION                          = MakePoint(252, 958);
    NTF_BUTTON_LEFT_POSITION                            = MakePoint(139, 958);
    NTF_BUTTON_RIGHT_POSITION                           = MakePoint(363, 958);
    NTF_MESSAGE_SIZE                                    = CCSizeMake(410, 105);
    
    // LeaderboardPopupView  position init
	// by apple Mon Jul 28 10:51:18 GMT+07:00 2014
	POP_LEADERBOARD_BG_SPRITE_POSITION                  = CCPoint(245, 50);
	POP_LEADERBOARD_FRAME_AVATAR_SPRITE_POSITION 		= MakePoint(50, 975);
	POP_LEADERBOARD_LEADERBOARD_BANNER_SPRITE_POSITION 		= POP_COMMON_HEADER_POSITION;
	POP_LEADERBOARD_NUMBER_1_SPRITE_POSITION            = MakePoint(422, 974);
	POP_LEADERBOARD_NUMBER_2_SPRITE_POSITION            = MakePoint(422, 974);
	POP_LEADERBOARD_NUMBER_3_SPRITE_POSITION            = MakePoint(422, 974);
	POP_LEADERBOARD_USERCHIP_LABEL_POSITION             = MakePoint(101, 997);
	POP_LEADERBOARD_USERNAME_LABEL_POSITION             = MakePoint(101, 955);
	POP_LEADERBOARD_YOUR_PLACE_LABEL_POSITION           = MakePoint(33, 316);
    POP_LEADERBOARD_TABLE_POSITION                      = MakePoint(33, 904);
    POP_LEADERBOARD_TABLE_CELL_POSITION                 = CCPoint(207, 50);
    POP_LEADERBOARD_BG_NUMBER_SPRITE_POSITION           = POP_LEADERBOARD_NUMBER_1_SPRITE_POSITION;
    
    POP_LEADERBOARD_TABLE_SIZE                          = CCSizeMake(490, 552);
    POP_LEADERBOARD_TABLE_CELL_SIZE                     = CCSizeMake(480, 100);
    POP_LEADERBOARD_AVATAR_SIZE                         = CCSizeMake(73, 73);
