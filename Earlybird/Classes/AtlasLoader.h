...
#ifndef __Earlybird__AtlasLoader__
#define __Earlybird__AtlasLoader__
...
protected:
     ...
     */
    AtlasLoader();
    AtlasLoader(const AtlasLoader &) = delete;
    void operator = (const AtlasLoader &) = delete;
     ...
     */
    Map<std::string, SpriteFrame*> mSpriteFrames;
};

#endif /* defined(__Earlybird__AtlasLoader__) */
